...
try {
  ...
  $stmt->execute([
      ...
      'peso' => is_numeric($_POST['peso'] ?? '') ? $_POST['peso'] : null,
      'dureza' => is_numeric($_POST['dureza'] ?? '') ? $_POST['dureza'] : null,
      'friabilidad' => is_numeric($_POST['friabilidad'] ?? '') ? $_POST['friabilidad'] : null,
      'disgregacion' => $_POST['disgregacion'] ?? null,
      'altura' => is_numeric($_POST['altura'] ?? '') ? $_POST['altura'] : null,
      'humedad' => is_numeric($_POST['humedad'] ?? '') ? $_POST['humedad'] : null,
      'peso1' => is_numeric($_POST['peso1'] ?? '') ? $_POST['peso1'] : null,
      'disgregacion1' => $_POST['disgregacion1'] ?? null,
      'altura1' => is_numeric($_POST['altura1'] ?? '') ? $_POST['altura1'] : null,
