...
try {
    ...
    $stmt->execute([
        ...
        'pct_humedad_estufa' => $_POST['pct_humedad_estufa'] ?? null,
        'humedad_pct' => $_POST['humedad_pct'] ?? null,
        'grueso' => $_POST['grueso'] ?? null,
        'entrefino' => $_POST['entrefino'] ?? null,
        'fino' => $_POST['fino'] ?? null,
        'densidad_aparente' => $_POST['densidad_aparente'] ?? null,
        'densidad_compactada' => $_POST['densidad_compactada'] ?? null,
        'indice_de_hausner' => $_POST['indice_de_hausner'] ?? null,
        'indice_de_carr' => $_POST['indice_de_carr'] ?? null,
        'disgregacion' => $_POST['disgregacion'] ?? null,
        'disgregacion1' => $_POST['disgregacion1'] ?? null,
        'pct_humedad' => $_POST['pct_humedad'] ?? null,
        'a_totales' => $_POST['a_totales'] ?? null,
        'enterobact' => $_POST['enterobact'] ?? null,
        'e_coli' => $_POST['e_coli'] ?? null,
        's_aureus' => $_POST['s_aureus'] ?? null,
        'hyl' => $_POST['hyl'] ?? null,
        'grados_brix' => $_POST['grados_brix'] ?? null,
        'peso_promedio_10_caramelos' => $_POST['peso_promedio_10_caramelos'] ?? null,
        'azucar_libre_gr' => $_POST['azucar_libre_gr'] ?? null
    ]);
